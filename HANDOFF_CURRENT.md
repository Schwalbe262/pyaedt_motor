...
3. Poll queued jobs 60/61; fetch result CSVs only after enough fixed-geometry profile groups complete, then run `analyze_ipmsm_quality_results.py` with the incomplete-group guard.
