...
- Batch2 is running through attached `fea_bursty` tasks after packed jobs 62-71 were cancelled before Slurm submission; current blocker is waiting for n107 tasks 8666/8670-8671/8676-8677/8686-8687/8692.
...
1. Poll remaining `/api/tasks/8666`,`8670`-`8671`,`8676`-`8677`,`8686`-`8687`,`8692` with filtered fields; fetch only per-task module result CSV row/status summaries.
...
- Partial batch2 evidence is now result_rows=79, ok=75, failed=4, duplicates=0; rescued n107 case 073 is `ok`, case 087 is running as task 8692, and rescued case 074 is still running.
