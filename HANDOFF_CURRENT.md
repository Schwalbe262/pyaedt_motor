...
- Batch3 all cases001-200 completed. Batch4 has completed=87/failed=15/cancelled=94/running=113, including 15 old no-bootstrap plumbing failures and corrected submissions through case200. Batch5 has cases001-086 submitted after a non-overlapping 200-case plan; total active FEA is 200.
...
4. With batch5 cases001-086 submitted, future refill can advance to batch5 case087+ when slots open; automated refills must use `/api/tasks`, deterministic `dedupe_key`, explicit Ansys module env setup, and per-case bootstrapped remote CSV paths.
...
- Partial batch2 evidence is result_rows=199, ok=193, failed=6, duplicates=0; batch3 partial200 is 191 ok / 9 failed; batch4 partial087 is 76 ok / 11 failed; `batch2p199_batch3p200_batch4p087` quality passed with 13,844 rows; p077 retrain still fails 8/8 targets with min R2 0.723311248898 and avg R2 0.821010077138; replay/source drift analysis found 630/630 matched replay rows and high torque/solidloss/efficiency drift; batch5 cases001-086 submitted.
