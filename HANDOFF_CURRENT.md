...
- Batch2 is running through attached `fea_bursty` tasks after packed jobs 62-71 were cancelled before Slurm submission; current blocker is waiting for n107 tasks 8603/8606-8607/8625-8629, n114 running tasks 8598-8599/8601, and n114 queued tasks 8630/8632-8633.
...
1. Poll remaining `/api/tasks/8603`,`8606`-`8607`,`8625`-`8629`,`8598`-`8599`,`8601`,`8630`,`8632`-`8633` with filtered fields; fetch only per-task module result CSV row/status summaries.
...
- Partial batch2 evidence is now result_rows=61, ok=57, failed=4, duplicates=0; n114 is `soft_blocked` with fit_slots=0, so keep queued 072-074 but do not submit more there yet.
