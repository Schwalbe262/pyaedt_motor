...
- Batch2 is running through attached `fea_bursty` tasks after packed jobs 62-71 were cancelled before Slurm submission; current blocker is waiting for n107 tasks 8654/8666/8670-8671/8676-8677/8686-8687.
...
1. Poll remaining `/api/tasks/8654`,`8666`,`8670`-`8671`,`8676`-`8677`,`8686`-`8687` with filtered fields; fetch only per-task module result CSV row/status summaries.
...
- Partial batch2 evidence is now result_rows=78, ok=74, failed=4, duplicates=0; n107 cases 072 and 080 are `ok`, cases 085-086 are running as tasks 8686-8687, and rescued cases 073-074 are still running.
