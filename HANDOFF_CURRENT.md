...
- 2026-06-17: batch2 has explicit partial192 summary at result_rows=192, ok=186, failed=6, duplicates=0, physical_sanity_violations=0; batch3 partial3 is 0 ok / 3 failed, all `analysis_returned_false=True`.
...
- Batch2 all cases001-200 are submitted; latest counts are completed=219, running=8, cancelled=3. Batch3 all cases001-200 are submitted; latest counts are queued=112, running=85, completed=3.
...
- Partial batch2 evidence is now result_rows=192, ok=186, failed=6, duplicates=0; combined partial192 filter/quality gates kept 13,570 rows with 0 duplicates, 0 missing required outputs, and 0 physical-sanity violations.
