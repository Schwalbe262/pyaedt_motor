...
- 2026-06-17: production concurrency reached 41 running tasks across n107/n108/n109/n110/n114/n115; explicit partial116 summary is result_rows=116, ok=111, failed=5, duplicates=0, physical_sanity_violations=0.
...
- Batch2 is running through attached `fea_bursty` tasks after packed jobs 62-71 were cancelled before Slurm submission; current active production tasks are 8757/8760, 8775-8777, 8792, 8795-8808, 8814-8815, 8818, 8821-8833, and 8835-8839.
...
1. Poll active production tasks 8757/8760, 8775-8777, 8792, 8795-8808, 8814-8815, 8818, 8821-8833, and 8835-8839 with filtered fields; fetch result CSV row/status summaries only, then backfill case 158 when a slot opens.
...
- Partial batch2 evidence is now result_rows=116, ok=111, failed=5, duplicates=0; recently fetched cases 097/098/099/100/102/104-108/112/114-121 are `ok`, and production concurrency is 41 running tasks.
