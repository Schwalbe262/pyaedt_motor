...
- Batch2 is running through attached `fea_bursty` tasks after packed jobs 62-71 were cancelled before Slurm submission; current blocker is waiting for n107 tasks 8651/8653-8654/8666/8670-8671/8676-8677.
...
1. Poll remaining `/api/tasks/8651`,`8653`-`8654`,`8666`,`8670`-`8671`,`8676`-`8677` with filtered fields; fetch only per-task module result CSV row/status summaries.
...
- Partial batch2 evidence is now result_rows=76, ok=72, failed=4, duplicates=0; n107 cases 078-079 are `ok`, cases 083-084 are running as tasks 8676-8677, and rescued cases 072-074 are still running.
