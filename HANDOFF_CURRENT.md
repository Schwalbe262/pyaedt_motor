...
- Batch2 is running through attached `fea_bursty` tasks after packed jobs 62-71 were cancelled before Slurm submission; current active production tasks are 8742/8744/8749/8750/8757/8758/8760, 8764, 8771-8778, 8780-8786, 8788, and 8792.
...
1. Poll active production tasks 8742/8744/8749/8750/8757/8758/8760, 8764, 8771-8778, 8780-8786, 8788, and 8792 with filtered fields; fetch result CSV row/status summaries only, then backfill case 123 when a slot opens.
...
- Partial batch2 evidence is now result_rows=97, ok=92, failed=5, duplicates=0; case096 is `ok`, case113 failed `analysis_returned_false=True`, and production concurrency remains 25 running tasks.
