...
- 2026-06-17: batch2 has explicit partial199 summary at result_rows=199, ok=193, failed=6, combined_kept=13,577, duplicates=0, physical_sanity_violations=0; batch3 partial107 is 98 ok / 9 failed.
...
7. Diagnose the batch3 `analysis=False` cluster before promoting a new exclusion rule; partial107 has 98 ok / 9 failed, and the narrow height/setback/shield rule still has five ok false positives.
