...
- Batch2 is running through attached `fea_bursty` tasks after packed jobs 62-71 were cancelled before Slurm submission; current blocker is waiting for n107 tasks 8603/8606-8607/8625-8629 and n114 tasks 8596-8602 plus queued task 8630.
...
1. Poll remaining `/api/tasks/8603`,`8606`-`8607`,`8625`-`8629` and `/api/tasks/8596`-`8602`,`8630` with filtered fields; fetch only per-task module result CSV row/status summaries.
...
- n107 cases 051-055 and n114 case 056 finished `ok`; active follow-on work is n107 cases 064-071 and n114 cases 057-063 plus queued case 072.
