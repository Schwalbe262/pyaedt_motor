...
- 2026-06-17: production concurrency is 41 running tasks across n107/n108/n109/n110/n114/n115; explicit partial119 summary is result_rows=119, ok=114, failed=5, duplicates=0, physical_sanity_violations=0.
...
- Batch2 is running through attached `fea_bursty` tasks after packed jobs 62-71 were cancelled before Slurm submission; current active production tasks are 8760, 8777, 8792, 8795-8808, 8814-8815, 8818, 8821-8833, 8835-8839, 8842-8843, and 8845.
...
1. Poll active production tasks 8760, 8777, 8792, 8795-8808, 8814-8815, 8818, 8821-8833, 8835-8839, 8842-8843, and 8845 with filtered fields; fetch result CSV row/status summaries only, then backfill case 161 when a slot opens.
...
- Partial batch2 evidence is now result_rows=119, ok=114, failed=5, duplicates=0; recently fetched cases 101/109/110 are also `ok`, and production concurrency is 41 running tasks.
