...
- Batch2 is running through attached `fea_bursty` tasks after packed jobs 62-71 were cancelled before Slurm submission; current blocker is waiting for n107 tasks 8582-8584/8587-8591 and n114 module2 tasks 8573-8574/8576-8579 after quick `analysis=False` row 8575.
...
1. Poll remaining `/api/tasks/8582`-`8584`,`8587`-`8591` and `/api/tasks/8573`-`/api/tasks/8574`,`8576`-`/api/tasks/8579` with filtered fields; fetch only per-task module result CSV row/status summaries.
...
- n114 module wave cases 025-032 and n107 module wave cases 033-040 each finished 7/8 `ok`; follow-on cases 041-047, 048-050, and 051-055 are submitted as tasks 8573-8579, 8582-8584, and 8587-8591.
