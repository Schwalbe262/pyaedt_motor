...
- Batch2 is running through attached `fea_bursty` tasks after packed jobs 62-71 were cancelled before Slurm submission; current blocker is waiting for n107 tasks 8649-8651/8653-8654/8666/8670-8671.
...
1. Poll remaining `/api/tasks/8649`-`8651`,`8653`-`8654`,`8666`,`8670`-`8671` with filtered fields; fetch only per-task module result CSV row/status summaries.
...
- Partial batch2 evidence is now result_rows=74, ok=70, failed=4, duplicates=0; n107 cases 076-077 are `ok`, cases 081-082 are running as tasks 8670-8671, rescued cases 072-074 are still running, and fallback-node smoke 8662-8665 was cancelled before attach.
