...
- Batch2 is running through attached `fea_bursty` tasks after packed jobs 62-71 were cancelled before Slurm submission; current blocker is waiting for n107 tasks 8582-8584/8587-8591 and n114 tasks 8573/8576-8579/8595-8597 after quick `analysis=False` row 8575.
...
1. Poll remaining `/api/tasks/8582`-`8584`,`8587`-`8591` and `/api/tasks/8573`,`8576`-`8579`,`8595`-`8597` with filtered fields; fetch only per-task module result CSV row/status summaries.
...
- n114 module wave cases 025-032 and n107 module wave cases 033-040 each finished 7/8 `ok`; follow-on cases 041-047, 048-055, and 056-058 are submitted as tasks 8573-8579, 8582-8591, and 8595-8597.
