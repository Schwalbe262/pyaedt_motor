...
- Batch2 is running through attached `fea_bursty` tasks after packed jobs 62-71 were cancelled before Slurm submission; current blocker is waiting for n107 tasks 8603/8606-8607/8625-8629 and n114 queued tasks 8630/8632-8633.
...
1. Poll remaining `/api/tasks/8603`,`8606`-`8607`,`8625`-`8629`,`8630`,`8632`-`8633` with filtered fields; fetch only per-task module result CSV row/status summaries.
...
- Partial batch2 evidence is now result_rows=63, ok=59, failed=4, duplicates=0; n114 cases 056-063 are 8/8 `ok`, but n114 is still `soft_blocked` with queued cases 072-074.
