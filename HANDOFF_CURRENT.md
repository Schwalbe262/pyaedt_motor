...
- Batch2 is running through attached `fea_bursty` tasks after packed jobs 62-71 were cancelled before Slurm submission; current blocker is waiting for n107 tasks 8583-8584/8587-8591/8603 and n114 tasks 8595-8602.
...
1. Poll remaining `/api/tasks/8583`-`8584`,`8587`-`8591`,`8603` and `/api/tasks/8595`-`8602` with filtered fields; fetch only per-task module result CSV row/status summaries.
...
- n114 cases 041-047 finished row-wise 6/7 `ok`, and n107 case 048 finished `ok`; active follow-on work is n107 cases 049-055/064 and n114 cases 056-063.
