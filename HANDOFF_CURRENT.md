...
- Batch2 is running through attached `fea_bursty` tasks after packed jobs 62-71 were cancelled before Slurm submission; current blocker is waiting for n107 tasks 8640-8641/8649-8651/8653-8654/8666.
...
1. Poll remaining `/api/tasks/8640`-`8641`,`8649`-`8651`,`8653`-`8654`,`8666` with filtered fields; fetch only per-task module result CSV row/status summaries.
...
- Partial batch2 evidence is now result_rows=72, ok=68, failed=4, duplicates=0; n107 case 075 is `ok`, rescued case 074 is running as task 8666, cases 072-073 are running as tasks 8653-8654, and fallback-node smoke 8662-8665 was cancelled before attach.
