...
- Batch2 is running through attached `fea_bursty` tasks after packed jobs 62-71 were cancelled before Slurm submission; current blocker is waiting for n107 tasks 8670-8671/8676-8677/8686-8687/8692/8716.
...
1. Poll remaining `/api/tasks/8670`-`8671`,`8676`-`8677`,`8686`-`8687`,`8692`,`8716` with filtered fields; fetch only per-task module result CSV row/status summaries.
...
- Partial batch2 evidence is now result_rows=80, ok=76, failed=4, duplicates=0; rescued n107 case 074 is `ok`, so cases 072-080 now have complete result evidence, and case 088 is running as task 8716.
