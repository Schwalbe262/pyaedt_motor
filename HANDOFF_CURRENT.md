...
- Batch2 is running through attached `fea_bursty` tasks after packed jobs 62-71 were cancelled before Slurm submission; current blocker is waiting for n107 tasks 8591/8603/8606-8607/8625-8628 and n114 tasks 8595-8602.
...
1. Poll remaining `/api/tasks/8591`,`8603`,`8606`-`8607`,`8625`-`8628` and `/api/tasks/8595`-`8602` with filtered fields; fetch only per-task module result CSV row/status summaries.
...
- n107 cases 051-054 finished `ok`; active follow-on work is n107 cases 055/064-070 and n114 cases 056-063.
