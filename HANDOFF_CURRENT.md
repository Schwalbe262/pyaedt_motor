...
- 2026-06-16: production replay snapshots now have 151 fetched rows; raw partial has 136 `ok`, 15 failed, and 13 retry duplicates, while `partial151_bomfix` keeps 13,328 rows with no blank/duplicate case IDs and no physical-sanity violations.
- 2026-06-16: `train_ipmsm_lightgbm.py --data simul_log_smoke\training_ready_physical_plus_mtf200_partial151_bomfix.csv --disable-tuning` passed row gates with 0 invalid rows and 0 duplicate drops; R2 remains below target with min 0.6969352965, avg 0.81806478457.
