...
- Latest scheduler sample: batch3 has completed=197/running=3, batch4 has completed=45/failed=15/cancelled=94/queued=49/running=106, batch5 cases001-041 are queued, and total queued/running/attaching FEA is at the clarified cap of 200.
- Batch3 partial197 is ok=188/failed=9, with failed cases029/043/050/109/134/139/147/158/169 still diagnostic; batch4 partial045 is ok=39/failed=6, with failed cases028/075/108/118/132/136 missing required transient outputs; batch2p199+batch3p197+batch4p045 keeps 13,804 quality-passing rows with zero duplicate case IDs, zero missing required rows, and zero physical-sanity violations after filtering.
...
- Batch5 `mesh_time_fine` has 200 unique new source cases, excludes all 800 batch1-4 source IDs plus the conservative rule `magnet_height_ratio>=0.942,magnet_setback_ratio>=0.121`, and has 0 overlap with prior batches; cases001-041 are submitted.
