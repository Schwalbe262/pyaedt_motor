...
- Latest scheduler sample: batch2 has completed=224, running=3, cancelled=3; batch3 has queued=72, running=121, completed=7; batch3 partial007 is ok=3/failed=4, with failed cases029/043/050/109 all `analysis_returned_false=True`.
- Batch3 partial007 failure-pattern evidence is diagnostic only: `input_rotator_gap<=1.64` and the three-rule conjunction currently match 3/4 failed rows and 0/3 ok rows, so the sample is too small and incomplete for a confirmed exclusion rule.
