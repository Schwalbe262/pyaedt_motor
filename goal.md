...
- Latest scheduler sample: batch2 has completed=224, running=3, cancelled=3; batch3 has queued=48, running=141, completed=11; batch4 has queued=8, so active queued/running FEA is at the clarified cap of 200.
- Batch3 partial011 is ok=5/failed=6, with failed cases029/043/050/109/134/139 all `analysis_returned_false=True`; current candidate rules remain diagnostic because they either miss failed rows or match too many historical ok rows.
- Batch4 `mesh_time_fine` plan has 200 unique new source cases, excludes batch1/batch2/batch3 source IDs plus the conservative rule `magnet_height_ratio>=0.942,magnet_setback_ratio>=0.121`, and cases001-008 were submitted as `/tasks` 9130-9133, 9135-9136, 9139, and 9141.
