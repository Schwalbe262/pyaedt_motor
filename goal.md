...
- First production replay evidence is available: tasks 8152, 8154, and 8158 produced 3 `mesh_time_fine` `ok` rows, and partial quality/filter gates passed with zero physical sanity violations.
