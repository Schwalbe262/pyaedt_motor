...
- Latest scheduler sample: batch3 has completed=198/running=2, batch4 has completed=68/failed=15/cancelled=94/running=132, batch5 cases001-065 are submitted, and total queued/running/attaching FEA is at the clarified cap of 200.
- Batch3 partial198 is ok=189/failed=9, with failed cases029/043/050/109/134/139/147/158/169 still diagnostic; batch4 partial068 is ok=57/failed=11, with failed cases028/075/108/118/132/136/169/174/176/181/185 missing required transient outputs; batch2p199+batch3p198+batch4p065 remains the current training-ready gate with 13,823 quality-passing rows because partial068 added no ok rows.
...
- Batch5 `mesh_time_fine` has 200 unique new source cases, excludes all 800 batch1-4 source IDs plus the conservative rule `magnet_height_ratio>=0.942,magnet_setback_ratio>=0.121`, and has 0 overlap with prior batches; cases001-065 are submitted.
