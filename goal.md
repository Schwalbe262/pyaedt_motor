...
- Latest scheduler sample: batch2 still has one running task; batch3 has completed=184/running=16; batch4 has completed=14/failed=15/cancelled=94/queued=85/running=98, so active queued/running/attaching FEA is at the clarified cap of 200.
- Batch3 partial184 is ok=175/failed=9, with failed cases029/043/050/109/134/139/147/158/169 still diagnostic; batch2p199+batch3p184 keeps 13,752 quality-passing rows with zero duplicate case IDs, zero missing required rows, and zero physical-sanity violations after filtering.
- Batch4 cases081-095 failed from submission plumbing (`remote/cases.csv` missing), not simulation quality; bad nonterminal cases096-189 were cancelled, corrected cases081-189 were resubmitted, and cases190-197 were submitted through `/api/tasks` with deterministic `dedupe_key`s and per-case bootstrapped remote CSV paths.
