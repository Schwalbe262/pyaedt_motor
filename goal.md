...
- Latest scheduler sample: batch2 has completed=226, running=1, cancelled=3; batch3 has queued=18, running=140, completed=42; batch4 has queued=41, so active queued/running FEA is at the clarified cap of 200.
- Batch3 partial042 is ok=33/failed=9, with failed cases029/043/050/109/134/139/147/158/169 all `analysis_returned_false=True`; current candidate rules remain diagnostic because the narrow height/setback/shield rule now matches 2 ok rows, and broader rules match 7 ok rows.
- Batch4 `mesh_time_fine` plan has 200 unique new source cases, excludes batch1/batch2/batch3 source IDs plus the conservative rule `magnet_height_ratio>=0.942,magnet_setback_ratio>=0.121`, and cases001-041 are queued as `/tasks` 9130-9133, 9135-9136, 9139, 9141, 9143-9145, 9147, 9149-9151, 9153, 9156, 9158, 9160, 9166-9173, 9176-9178, 9181-9187, and 9190-9193.
- LightGBM retraining on `partial219_bomfix` plus batch2 partial199 and batch3 partial038 keeps 13,606 rows with no invalid training rows, but still misses the target with min R2 0.722786084526 and avg R2 0.821023691155.
