...
- Latest scheduler sample: batch2 has completed=226, running=1, cancelled=3; batch3 has queued=16, running=135, completed=49; batch4 has queued=48, so active queued/running FEA is at the clarified cap of 200.
- Batch3 partial049 is ok=40/failed=9, with failed cases029/043/050/109/134/139/147/158/169 all `analysis_returned_false=True`; current candidate rules remain diagnostic because the narrow height/setback/shield rule matches 2 ok rows, and broader rules match 8 ok rows.
- Batch4 `mesh_time_fine` plan has 200 unique new source cases, excludes batch1/batch2/batch3 source IDs plus the conservative rule `magnet_height_ratio>=0.942,magnet_setback_ratio>=0.121`, and cases001-048 are queued as `/tasks` 9130-9133, 9135-9136, 9139, 9141, 9143-9145, 9147, 9149-9151, 9153, 9156, 9158, 9160, 9166-9173, 9176-9178, 9181-9187, 9190-9193, and 9196-9202.
