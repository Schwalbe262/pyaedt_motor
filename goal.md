...
- LightGBM retraining on the combined `partial216_bomfix` dataset now preserves all case IDs and has 0 invalid training rows, but still misses the R2 target with min R2 0.721111975302 and avg R2 0.826273728953.
