...
- Latest scheduler sample: batch2 has completed=226, running=1, cancelled=3; batch3 has running=122, completed=78; batch4 has queued=68, running=9, so active queued/running FEA is at the clarified cap of 200.
- Batch3 partial078 is ok=69/failed=9, with failed cases029/043/050/109/134/139/147/158/169 all `analysis_returned_false=True`; current candidate rules remain diagnostic because the narrow height/setback/shield rule matches 2 ok rows, and broader rules match 12 ok rows.
- Batch4 `mesh_time_fine` plan has 200 unique new source cases, excludes batch1/batch2/batch3 source IDs plus the conservative rule `magnet_height_ratio>=0.942,magnet_setback_ratio>=0.121`, and cases001-077 are queued/running as `/tasks` through 9242.
